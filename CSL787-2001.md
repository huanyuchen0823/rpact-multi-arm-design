...
3.  Generalize the results to different hazard ratios (HRs) of 0.6, 0.7,
    0.8, and 0.9.
...
- **Key Results:**
  ...
  - **Expected number of subjects under H1:**
    ...
    - Expected number of subjects under H1 decreases from 122.7 (HR =
      0.6) to 109.9 (HR = 0.9).

    - The expected number of subjects decreases with increasing HR
      values, indicating a higher likelihood of early stopping as the
