...
| Stage levels (one-sided)           | 0      | 0.1000 |
| Futility boundary (z-value scale)  | 0.076  |        |
| Reject at least one                | 0.7810 |        |
| Rejected arms per stage            |        |        |
| Treatment arm vs. control          | 0      | 0.7810 |
| Treatment arm vs. control          | 0      | 0.5040 |
| Success per stage                  | 0      | 0.5040 |
| Exit probability for futility      | 0.0920 |        |
| Expected number of events under H1 | 91.1   |        |
| Overall exit probability           | 0.0920 |        |
| Cumulative number of events        |        |        |
| Treatment arm vs. control          | 31.3   | 66.6   |
| Treatment arm vs. control          | 33.3   | 70.8   |
| Selected arms                      |        |        |
| Treatment arm vs. control          | 1.0000 | 0.9080 |
| Treatment arm vs. control          | 1.0000 | 0.9080 |
| Number of active arms              | 2.000  | 2.000  |
| Conditional power (achieved)       |        | 0.7975 |
...
power = 0.8, minimum events per stage = c(45, 30), maximum events per
stage = c(45, 60), simulation runs = 1000, seed = 12345.
...
| Stage levels (one-sided)           | 0      | 0.1000 |
| Futility boundary (z-value scale)  | 0.076  |        |
| Reject at least one                | 0.5430 |        |
| Rejected arms per stage            |        |        |
| Treatment arm vs. control          | 0      | 0.5430 |
| Treatment arm vs. control          | 0      | 0      |
| Success per stage                  | 0      | 0.5430 |
| Exit probability for futility      | 0.1130 |        |
| Expected number of events under H1 | 81.5   |        |
| Overall exit probability           | 0.1130 |        |
| Cumulative number of events        |        |        |
| Treatment arm vs. control          | 27.5   | 61.8   |
| Treatment arm vs. control          | 30.0   | 55.1   |
| Selected arms                      |        |        |
| Treatment arm vs. control          | 1.0000 | 0.6280 |
| Treatment arm vs. control          | 1.0000 | 0.2590 |
| Number of active arms              | 2.000  | 1.000  |
| Conditional power (achieved)       |        | 0.7521 |
