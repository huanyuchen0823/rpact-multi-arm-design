...
summary(getPowerSurvival(design, directionUpper = FALSE, lambda2 = 1.2,
                         ...
                         # accrualIntensity = 78.7 if sample size = 144
                         )
        )
```
...
design <- getDesignInverseNormal(
  ...
  # userBetaSpending = c(0.070, 0.198) # rho = 1.07
...
| Stage levels (one-sided)           | 0      | 0.1000 |
| Futility boundary (z-value scale)  | 0.076  |        |
| Reject at least one                | 0.7684 |        |
| Rejected arms per stage            |        |        |
| Treatment arm vs. control          | 0      | 0.7684 |
| Treatment arm vs. control          | 0      | 0.4930 |
| Success per stage                  | 0      | 0.4930 |
| Exit probability for futility      | 0.0940 |        |
| Expected number of events under H1 | 90.9   |        |
| Overall exit probability           | 0.0940 |        |
| Cumulative number of events        |        |        |
| Treatment arm vs. control          | 31.3   | 66.5   |
| Treatment arm vs. control          | 33.3   | 70.7   |
| Selected arms                      |        |        |
| Treatment arm vs. control          | 1.0000 | 0.9060 |
| Treatment arm vs. control          | 1.0000 | 0.9060 |
| Number of active arms              | 2.000  | 2.000  |
| Conditional power (achieved)       |        | 0.8049 |
...
| Stage levels (one-sided)           | 0      | 0.1000 |
| Futility boundary (z-value scale)  | 0.076  |        |
| Reject at least one                | 0.5872 |        |
| Rejected arms per stage            |        |        |
| Treatment arm vs. control          | 0      | 0.5872 |
| Treatment arm vs. control          | 0      | 0      |
| Success per stage                  | 0      | 0.5872 |
| Exit probability for futility      | 0.0874 |        |
| Expected number of events under H1 | 87.1   |        |
| Overall exit probability           | 0.0874 |        |
| Cumulative number of events        |        |        |
| Treatment arm vs. control          | 31.3   | 71.7   |
| Treatment arm vs. control          | 33.3   | 67.3   |
| Selected arms                      |        |        |
| Treatment arm vs. control          | 1.0000 | 0.6350 |
| Treatment arm vs. control          | 1.0000 | 0.2776 |
| Number of active arms              | 2.000  | 1.000  |
| Conditional power (achieved)       |        | 0.8032 |
...
What beta spending function will we use in the multiarm design?

1.  O’Brien & Fleming
2.  Rho family: which rho will we take?
