...
| Exit probability for efficacy (under H1) | 0      |        |
| Exit probability for futility (under H0) | 0.4928 |        |
| Exit probability for futility (under H1) | 0.0582 |        |
...
| Futility boundary (t), HR = 0.7                | 1.004  |        |
...
| Efficacy boundary (z-value scale)                  | Inf    | 1.282  |
| Futility boundary (z-value scale)                  | -0.018 |        |
| Cumulative power, HR = 0.6                         | 0      | 0.8047 |
| Cumulative power, HR = 0.7                         | 0      | 0.5824 |
| Cumulative power, HR = 0.8                         | 0      | 0.3600 |
| Cumulative power, HR = 0.9                         | 0      | 0.1950 |
...
| Expected number of subjects under H1, HR = 0.6     | 123.0  |        |
| Expected number of subjects under H1, HR = 0.7     | 120.5  |        |
| Expected number of subjects under H1, HR = 0.8     | 116.4  |        |
| Expected number of subjects under H1, HR = 0.9     | 111.2  |        |
| Expected number of events, HR = 0.6                | 80.7   |        |
| Expected number of events, HR = 0.7                | 77.5   |        |
| Expected number of events, HR = 0.8                | 73.0   |        |
| Expected number of events, HR = 0.9                | 67.8   |        |
| Cumulative number of events                        | 41.5   | 83.1   |
...
| Expected study duration, HR = 0.9                  | 1.77   |        |
| Cumulative alpha spent                             | 0      | 0.1000 |
| Cumulative beta spent                              | 0.0590 | 0.1980 |
| One-sided local significance level                 | 0      | 0.1000 |
| Efficacy boundary (t)                              | 0      | 0.742  |
...
| Exit probability for futility (under H0)           | 0.4928 |        |
| Exit probability for futility (under H1), HR = 0.6 | 0.0582 |        |
| Exit probability for futility (under H1), HR = 0.7 | 0.1353 |        |
| Exit probability for futility (under H1), HR = 0.8 | 0.2432 |        |
| Exit probability for futility (under H1), HR = 0.9 | 0.3676 |        |
...
| Stage levels (one-sided)           | 0      | 0.1000 |
| Futility boundary (z-value scale)  | 0.076  |        |
| Reject at least one                | 0.7762 |        |
| Rejected arms per stage            |        |        |
| Treatment arm vs. control          | 0      | 0.2346 |
| Treatment arm vs. control          | 0      | 0.5416 |
| Success per stage                  | 0      | 0.7762 |
| Exit probability for futility      | 0.0804 |        |
| Expected number of events under H1 | 87.3   |        |
| Overall exit probability           | 0.0804 |        |
| Cumulative number of events        |        |        |
| Treatment arm vs. control          | 33.3   | 67.9   |
| Treatment arm vs. control          | 31.3   | 70.8   |
| Selected arms                      |        |        |
| Treatment arm vs. control          | 1.0000 | 0.3098 |
| Treatment arm vs. control          | 1.0000 | 0.6098 |
| Number of active arms              | 2.000  | 1.000  |
| Conditional power (achieved)       |        | 0.8193 |
