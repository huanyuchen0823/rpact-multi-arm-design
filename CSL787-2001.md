...
| Stage levels (one-sided)           | 0      | 0.1000 |
| Futility boundary (z-value scale)  | -0.018 |        |
| Reject at least one                | 0.7732 |        |
| Rejected arms per stage            |        |        |
| Treatment arm vs. control          | 0      | 0.7126 |
| Treatment arm vs. control          | 0      | 0.5502 |
| Success per stage                  | 0      | 0.4896 |
| Exit probability for futility      | 0.0714 |        |
| Expected number of events under H1 | 92.2   |        |
| Overall exit probability           | 0.0714 |        |
...
| Conditional power (achieved)       |        | 0.8123 |
